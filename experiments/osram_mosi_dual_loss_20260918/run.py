"""Train unchanged causal no-JEPA OSRAM with regression plus sign BCE."""
...
ROOT = REMOTE / "osram_mosi_dual_loss_20260918"
...
def train(seed: int) -> None:
    ...
    provenance = {
        ...
        "source_sha256": {
            ...
            for name in (
                ...
                "experiments/osram_mosi_dual_loss_20260918/run.py",
            )
        },
    }
    ...
    try:
        ...
        print(
            f"TRAIN seed={seed} no-JEPA dual-loss MOSI cyclic eta=.6 epochs={cfg.epochs}",
            flush=True,
        )
