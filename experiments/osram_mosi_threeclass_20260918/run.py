"""Train unchanged causal no-JEPA OSRAM with three-class MOSI supervision."""
...
ROOT = REMOTE / "osram_mosi_threeclass_20260918"
...
def train(seed: int) -> None:
    ...
    provenance = {
        ...
        "metric_protocol": "train-three-class-ce; test-nonzero-negative-positive-logit-pair",
        ...
        "source_sha256": {
            ...
            for name in (
                ...
                "experiments/osram_mosi_threeclass_20260918/run.py",
            )
        },
    }
    ...
    try:
        ...
        print(
            f"TRAIN seed={seed} no-JEPA three-class MOSI cyclic eta=.6 epochs={cfg.epochs}",
            flush=True,
        )
