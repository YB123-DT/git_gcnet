# Second Graph Aggregation Results
...
Detailed task-level evidence is preserved in [extension results](rtdr_extension/RESULTS.md) and [full-grid results](rtdr_full/RESULTS.md).
