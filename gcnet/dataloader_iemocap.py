...
def load_or_create_cache(cache_path, factory, fingerprint=None):
    """Load a pickle cache or create it once under an inter-process lock."""
...
def build_feature_path_index(feature_root, names):
    """Resolve all utterance paths with one directory scan."""
...
def load_iemocap_dataset(label_path, audio_root, text_root, video_root):
    """Load an assembled dataset from a source-fingerprinted shared cache."""
